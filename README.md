...
| `eks-manifest-auditor/` | Local Kubernetes/EKS manifest static analysis CLI | AWS 접속 없이 Kubernetes/EKS YAML의 보안, 리소스, Service, Ingress, IRSA 문제를 검사하는 Python CLI | Coming soon |
